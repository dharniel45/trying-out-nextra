...
import { Card, Cards } from 'nextra-theme-docs'} title="Get Started" href="/docs/docs-theme/start"> } title="Page Configuration" href="/docs/docs-theme/page-configuration"> } title="Theme Configuration" href="/docs/docs-theme/theme-configuration"> } title="Built-in Components" href="/docs/docs-theme/built-ins">
